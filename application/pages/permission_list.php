											...
											<table class="table" border="0.95">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<div align="center"><input name="loan_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="loan_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="loan_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="loan_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">5</td>
														...
														<td>
															<div align="center"><input name="msg_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="msg_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="msg_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="msg_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">6</td>
														...
														<td>
															<div align="center"><input name="mpay_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="mpay_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="mpay_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="mpay_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">7</td>
														...
														<td>
															<div align="center"><input name="payment_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="payment_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="payment_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="payment_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">8</td>
														...
														<td>
															<div align="center"><input name="emp_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="emp_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="emp_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="emp_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">9</td>
														...
														<td>
															<div align="center"><input name="permission_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="permission_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="permission_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="permission_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">10</td>
														...
														<td>
															<div align="center"><input name="savings_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="savings_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="savings_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="savings_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
													<tr>
														<td width="30">11</td>
														...
														<td>
															<div align="center"><input name="general_create" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="general_read" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="general_update" type="checkbox" value="On"></div>
														</td>
														<td>
															<div align="center"><input name="general_delete" type="checkbox" value="On"></div>
														</td>
													</tr>
												</tbody>
											</table>
